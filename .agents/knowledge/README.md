...
| Touching `trainers/dynamic_allocation.py`, `dynamic_allocation*` hparams, adaptive rollout budget | `topics/dynamic_allocation.md` |
| Touching `trainers/pivot_advantage.py`, `pivot_advantage` hparam, `sd3_5.inference` `latents=` injection | `topics/pivot_advantage.md` |
